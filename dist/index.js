...
var FooterModals = ({
  ...
  const [portalReady, setPortalReady] = (0, import_react9.useState)(false);
  const captchaContainerRef = (0, import_react9.useRef)(null);
...
function useMainNavItems(options) {
  ...
  const [nav, setNav] = (0, import_react10.useState)(fallback);
