...
var HeaderLoginModals = (0, import_react4.memo)(HeaderLoginModalsInner);

// src/components/header/login/useHeaderLoginShell.tsx
var import_jsx_runtime8 = require("react/jsx-runtime");
function useHeaderLoginShell(enabled = true) {
  const [showModals] = (0, import_react5.useState)(() => !hostHasLoginModals());
...
function useBhashiniWidgetPlacement(enabled = true) {
  const moveBhashiniToTarget = (0, import_react8.useCallback)(() => {
  ...
  const pollUntilWidgetReady = (0, import_react8.useCallback)(() => {
    const started = Date.now();
    const tryMove = () => {
