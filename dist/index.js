...
var FooterModals = ({
  ...
  const [portalReady, setPortalReady] = (0, import_react8.useState)(false);
  const captchaContainerRef = (0, import_react8.useRef)(null);
...
function useMainNavItems(options) {
  ...
  const [nav, setNav] = (0, import_react9.useState)(fallback);
