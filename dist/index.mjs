/*! mybharat_common_frontend@1.0.170 — if this version is wrong in Sources, Vite cached an old pre-bundle; see README "Vite dev server" */
...
function HeaderMobileStrip({ cdn, variant }) {
  ...
  return /* @__PURE__ */ jsx4("div", { className: `col-12 d-lg-none ${s.bar}`, children: /* @__PURE__ */ jsxs4("div", { className: s.row, children: [
    ...
    /* @__PURE__ */ jsxs4("div", { className: s.mid, children: [
      /* @__PURE__ */ jsx4("a", { href: "tel:18002122729", title: "Toll Free", id: "toll_mb", className: s.tollLink, children: /* @__PURE__ */ jsxs4("strong", { className: "lang_toll_free", children: [
        /* @__PURE__ */ jsx4("i", { className: "fa fa-phone mb-common-header__toll-phone-icon", "aria-hidden": "true" }),
        " ",
        "14472 Or 18002122729"
      ] }) }),
      /* @__PURE__ */ jsx4("div", { id: "bhashini-mobile-header", className: s.bhashini, children: /* @__PURE__ */ jsxs4("span", { className: "mb-common-header__bhashini-fallback", "aria-hidden": "true", children: [
        /* @__PURE__ */ jsx4("span", { children: "\u0905" }),
        /* @__PURE__ */ jsx4("span", { children: "A" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx4("div", { className: s.end, children: /* @__PURE__ */ jsx4(
      "button",
      {
        type: "button",
        className: s.menuBtn,
...
function MobileNavLinkRow({ item }) {
  ...
  return /* @__PURE__ */ jsx5(
    "a",
    {
      ...
      style: { marginLeft: 0 },
      ...external ? { target: "_blank", rel: "noopener noreferrer" } : {},
      children: /* @__PURE__ */ jsx5("span", { className: spanClass, style: { marginLeft: 0 }, children: item.label })
    }
  );
}
function MobileNavNode({ item, segments }) {
  if (!isNavGroupItem(item)) {
    return /* @__PURE__ */ jsx5("li", { children: /* @__PURE__ */ jsx5(MobileNavLinkRow, { item }) });
  }
  const path = navTreeItemKey(item, segments);
  const collapseId = collapseDomId(path);
  return /* @__PURE__ */ jsxs5("li", { className: "border-0", children: [
    /* @__PURE__ */ jsxs5(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ jsx5("i", { className: "fa fa-chevron-down small", "aria-hidden": "true" })
        ]
      }
    ),
    /* @__PURE__ */ jsx5("div", { id: collapseId, className: "collapse", children: /* @__PURE__ */ jsx5("ul", { className: "list-unstyled mb-0 ps-3 pb-1 border-start ms-1", children: item.children.map((child, j) => {
      const childSegments = [...segments, j];
      return /* @__PURE__ */ jsx5(MobileNavNode, { item: child, segments: childSegments }, navTreeItemKey(child, childSegments));
    }) }) })
  ] });
}
var MobileMenuModal = ({ cdnBase, items }) => {
  ...
  return /* @__PURE__ */ jsx5(
    "div",
    {
      ...
      "aria-hidden": "true",
      children: /* @__PURE__ */ jsx5("div", { className: "modal-dialog", children: /* @__PURE__ */ jsxs5("div", { className: "modal-content", children: [
        /* @__PURE__ */ jsxs5("div", { className: "modal-header align-items-center border-0 pb-0", children: [
          /* @__PURE__ */ jsx5("h5", { className: "modal-title flex-grow-1 mb-0", id: "mobileMenuNewLabel", children: /* @__PURE__ */ jsx5("div", { className: "logo", children: /* @__PURE__ */ jsx5("a", { href: "/", "data-bs-dismiss": "modal", children: /* @__PURE__ */ jsx5(
            "img",
            {
          ...
          /* @__PURE__ */ jsx5("button", { type: "button", className: "btn-close", "data-bs-dismiss": "modal", "aria-label": "Close" })
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "modal-body pt-2", children: [
          /* @__PURE__ */ jsx5("div", { className: "m-menu", children: /* @__PURE__ */ jsx5("ul", { className: "list-unstyled mb-0", children: tree.map((item, i) => {
            const segments = [i];
            return /* @__PURE__ */ jsx5(MobileNavNode, { item, segments }, navTreeItemKey(item, segments));
          }) }) }),
          /* @__PURE__ */ jsx5("div", { className: "m-menu border-top mt-2 pt-2", children: /* @__PURE__ */ jsxs5("ul", { className: "list-unstyled mb-0", children: [
            /* @__PURE__ */ jsx5("li", { children: /* @__PURE__ */ jsx5(
              "a",
              {
                ...
                children: /* @__PURE__ */ jsx5("span", { className: "lang_yuva_register_login_link d-block py-2", style: { marginLeft: 0 }, children: "Sign In" })
              }
            ) }),
            /* @__PURE__ */ jsx5("li", { children: /* @__PURE__ */ jsx5(
              "a",
              {
                ...
                "data-bs-dismiss": "modal",
                style: { borderBottom: "1px solid #D7D7D7" },
                children: /* @__PURE__ */ jsx5("span", { className: "lang_register d-block py-2", style: { marginLeft: 0 }, children: "Register Now" })
              }
            ) })
          ] }) }),
          /* @__PURE__ */ jsx5("div", { className: "accordion mt-2", id: "accordionExamples", children: /* @__PURE__ */ jsxs5("div", { className: "accordion-item border-0", children: [
            /* @__PURE__ */ jsx5("h2", { className: "accordion-header", id: "headingTwos", children: /* @__PURE__ */ jsx5(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx5("span", { className: "lang_register", children: "Get Started" })
              }
            ) }),
            /* @__PURE__ */ jsx5(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxs5("div", { className: "accordion-body", children: [
                  /* @__PURE__ */ jsxs5(
                    "a",
                    {
                      ...
                      style: { borderBottom: "1px solid #D7D7D7" },
                      children: [
                        /* @__PURE__ */ jsx5("span", { className: "lang_yuva", children: "Youth" }),
                        /* @__PURE__ */ jsx5("br", {}),
                        /* @__PURE__ */ jsx5("span", { className: "f-10-dropdown lang_applicants_volunteer", children: "Applicants/Volunteers/Participants" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxs5(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx5("span", { className: "lang_partner", children: "Partner" }),
                        /* @__PURE__ */ jsx5("br", {}),
                        /* @__PURE__ */ jsx5("span", { className: "f-10-dropdown lang_BYCN", children: "Knowledge Institution/ Businesses/Government/NGOs/Youth Club/Academia/" }),
                        /* @__PURE__ */ jsx5("br", {}),
                        /* @__PURE__ */ jsx5("span", { className: "f-10-dropdown lang_dyo_nss_register", children: "DYOs/NSS Program Officers/Placement Officers" })
                      ]
                    }
                  )
                ] })
...
var Header = ({ title = "MyBharat", cdnBase, mainNavItems }) => {
  ...
  return /* @__PURE__ */ jsxs6(Fragment, { children: [
    /* @__PURE__ */ jsxs6("header", { id: "mb-common-header-root", className: "fixed-top shadow mb-common-header", "aria-label": title, children: [
      /* @__PURE__ */ jsx6("div", { className: "bhashini-plugin-container" }),
  ...
  return /* @__PURE__ */ jsxs7(Fragment2, { children: [
    /* @__PURE__ */ jsxs7(
      "header",
      {
        ...
        "aria-label": title,
        children: [
          /* @__PURE__ */ jsx7("div", { className: "bhashini-plugin-container" }),
          ...
          /* @__PURE__ */ jsx7("div", { className: "header-area header-white bg-white pt-10 pb-10 mt-sm-0 mb-common-header__header-area", children: /* @__PURE__ */ jsx7("div", { className: "container", children: /* @__PURE__ */ jsxs7("div", { className: "row align-items-center gx-2", children: [
            ...
            /* @__PURE__ */ jsxs7("div", { className: "col-xl-10 col-lg-10 d-none d-lg-block", children: [
              /* @__PURE__ */ jsx7("div", { className: "f-hd-right" }),
...
var FooterModals = ({
  ...
  const content = /* @__PURE__ */ jsxs8(Fragment3, { children: [
      ...
      /* @__PURE__ */ jsxs8("div", { className: "row", children: [
        /* @__PURE__ */ jsx8("div", { className: "col-sm-10", children: /* @__PURE__ */ jsxs8("form", { id: "feedbackFrm", children: [
          ...
          /* @__PURE__ */ jsxs8("div", { className: "row pb-10", children: [
            ...
            !isLoggedIn ? /* @__PURE__ */ jsxs8(Fragment3, { children: [
  ...
  return /* @__PURE__ */ jsxs9(Fragment4, { children: [
    /* @__PURE__ */ jsxs9("footer", { id: "footer_external", className: "footer-area-1 mb-common-footer", children: [
      /* @__PURE__ */ jsx9("div", { className: "footer-top py-3", children: /* @__PURE__ */ jsx9("div", { className: "container", children: /* @__PURE__ */ jsxs9("div", { className: "row", children: [
        ...
        /* @__PURE__ */ jsxs9("div", { className: "col-lg-3 col-md-6 footer-links pt-4", children: [
...
// src/index.ts
var MYBHARAT_COMMON_FRONTEND_VERSION = "1.0.170";
