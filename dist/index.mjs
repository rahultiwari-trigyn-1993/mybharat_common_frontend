...
var DesktopMainNav = ({ items }) => {
  ...
  return /* @__PURE__ */ jsx("ul", { className: "menu_nav1", children: tree.map((item, index) => /* @__PURE__ */ jsx(TopItem, { item, index }, index)) });
};
...
var MobileMenuModal = ({ cdnBase, items }) => {
  const rootPath = React2.useId().replace(/:/g, "");
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx2("div", { className: "modal-dialog", children: /* @__PURE__ */ jsxs2("div", { className: "modal-content", children: [
        ...
        /* @__PURE__ */ jsxs2("div", { className: "modal-body pt-2", children: [
          /* @__PURE__ */ jsx2("div", { className: "m-menu", children: /* @__PURE__ */ jsx2("ul", { className: "list-unstyled mb-0", children: tree.map((item, i) => /* @__PURE__ */ jsx2(MobileNavNode, { item, path: `${rootPath}-${i}` }, `${rootPath}-${i}`)) }) }),
