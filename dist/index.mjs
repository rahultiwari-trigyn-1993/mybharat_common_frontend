/*! mybharat_common_frontend@1.0.189 — if this version is wrong in Sources, Vite cached an old pre-bundle; see README "Vite dev server" */
...
function HeaderMobileStrip({ cdn, variant }) {
  ...
  const tollLink = /* @__PURE__ */ jsx4("a", { href: "tel:18002122729", title: "Toll Free", id: "toll_mb", className: s.tollLink, children: /* @__PURE__ */ jsxs4("strong", { className: "lang_toll_free", children: [
    /* @__PURE__ */ jsx4("i", { className: "fa fa-phone mb-common-header__toll-phone-icon", "aria-hidden": "true", style: { transform: "rotate(90deg)" } }),
    " ",
...
// src/index.ts
var MYBHARAT_COMMON_FRONTEND_VERSION = "1.0.189";
