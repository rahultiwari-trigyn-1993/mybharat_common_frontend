/*! mybharat_common_frontend@1.0.175 — if this version is wrong in Sources, Vite cached an old pre-bundle; see README "Vite dev server" */
...
function HeaderMobileStrip({ cdn, variant }) {
  ...
  const tollAndBhashini = /* @__PURE__ */ jsxs4(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx4("div", { id: "bhashini-mobile-header", className: s.bhashini })
  ] });
...
// src/index.ts
var MYBHARAT_COMMON_FRONTEND_VERSION = "1.0.175";
