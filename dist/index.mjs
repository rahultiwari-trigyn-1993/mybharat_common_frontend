/*! mybharat_common_frontend@1.0.181 — if this version is wrong in Sources, Vite cached an old pre-bundle; see README "Vite dev server" */
...
// src/index.ts
var MYBHARAT_COMMON_FRONTEND_VERSION = "1.0.181";
