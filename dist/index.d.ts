...
declare function isSameOriginApiBase(base: string): boolean;
/** Normalize configured APIGateway root for browser `fetch`. */
declare function resolveBrowserApiBaseUrl(configured?: string): string;
